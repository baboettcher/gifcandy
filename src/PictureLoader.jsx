...
class PictureLoader extends Component {
  ...
  randomWord() {
    const wordNikQuery =
      "http://api.wordnik.com/v4/words.json/randomWord?api_key=" + WORDNIK_KEY;
  ...
  render() {
    return (
      <div>
        <p>Quilt / Memory game / Invaders / ML</p>
        ...
        <button>Clear</button>
        <div className="topContainer">{this.state.picturesLoaded}</div>
      </div>
    );
  }
}
